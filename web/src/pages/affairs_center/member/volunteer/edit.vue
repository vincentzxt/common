<template>
  <div>
    <Modal v-model="showModal" title="编辑组织结构" :loading="showLoading" :mask-closable="false" width="70%"   :styles="{top: '20px'}" class="cutomer-modal-box-gay" @on-ok="handleSubmit" @on-cancel="handleClose">
