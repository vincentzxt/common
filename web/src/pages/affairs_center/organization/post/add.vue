<template>
  <div>
    <Modal v-model="showModal" title="添加党内职务" :loading="showLoading" :mask-closable="false" width="40%" :styles="{top: '20px'}" class="cutomer-modal-box-gay" @on-ok="handleSubmit" @on-cancel="handleClose">
