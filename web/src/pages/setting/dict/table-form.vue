<template>
    <Form ref="form" :model="data" :rules="rules" :label-width="labelWidth" label-position="left" v-if="searchStatus">
        <Row :gutter="24" type="flex" justify="end">
            ...
            <Col v-bind="grid">
                <FormItem label="真实姓名：" prop="status1" label-for="status1">
            ...
            <template v-if="collapse">
                <Col v-bind="grid">
                    <FormItem label="手机号：" prop="count" label-for="count">
