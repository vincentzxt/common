<template>
	<div>
			<Card :bordered="false" dis-hover :padding="8">
				...
				<a href="#" slot="extra" @click.prevent="handleOpenAdd" style="font-weight: 500;">
							发送消息
						</a>
			<!-- 	<div class="tool">
...
import { listSendMessage,} from '@/api/setting/message';
	...
	data() {
		return {
			...
			columns: [
				...
				{ title: '发送时间', key: 'created_at', minWidth: 180 },
				...
				{ title: '已读人数', key: 'message_read_count', minWidth: 100 }
			],
			loading: false,
			loadAdd: false,
