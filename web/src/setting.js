...
const Setting = {
    ...
    // 接口请求地址
    apiBaseURL: env === 'development' ? 'http://t.api.stararea.cn' : 'http://t.api.stararea.cn',
    // Oss 地址
    ossURL: env === 'development' ? 'https://wyadmin.oss-cn-beijing.aliyuncs.com/' : 'https://wyadmin.oss-cn-beijing.aliyuncs.com/',
